...
2. 현재 칸의 주변 4칸 중 청소되지 않은 빈 칸이 없는 경우,
    i. 바라보는 방향을 유지한 채로 한 칸 후진할 수 있다면 한 칸 후진하고 1번으로 돌아간다.
    ii. 바라보는 방향의 뒤쪽 칸이 벽이라 후진할 수 없다면 작동을 멈춘다.
3. 현재 칸의 주변 4칸 중 청소되지 않은 빈 칸이 있는 경우,
    i. 반시계 방향으로 90도 회전한다.
    ii. 바라보는 방향을 기준으로 앞쪽 칸이 청소되지 않은 빈 칸인 경우 한 칸 전진한다.
    iii. 1번으로 돌아간다
*/

/*
입력
첫째 줄에 방의 크기 N(<=50)과 M(<=50)이 입력된다. 
